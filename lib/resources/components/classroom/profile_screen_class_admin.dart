...
class ProfileScreenClass extends StatefulWidget {
  final Class user;
  const ProfileScreenClass({super.key, required this.user});
  @override
  State<ProfileScreenClass> createState() => _ProfileScreenState();
}

class _ProfileScreenState extends State<ProfileScreenClass> {
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton.icon(
                      ...
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          ...
                          APIs.updateClassInfo(community).then((value) {
                    ...
                    SingleChildScrollView(
                      child: StreamBuilder(
                          stream: APIs.getClassParticipantsInfo(widget.user.id),
