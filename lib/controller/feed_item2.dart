...
class _FeedItem2State extends State<FeedItem2> {
  ...
  void initState() {
    _controller = VideoPlayerController.networkUrl(
        Uri.parse(widget.video[widget.index].videoUrl))
      ..initialize().then((value) {
        _controller.play();
        _controller.setVolume(1).whenComplete(
          () {
            Dialogs.showSnackbar(context, 'Video loaded');
          },
        );
      });
    likeTapped = false;
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            widget.video[widget.index].title,
                            style: const TextStyle(
                                color: Colors.white, fontSize: 20),
                          ),
                          Text(
                            widget.video[widget.index].description,
                            style: const TextStyle(
